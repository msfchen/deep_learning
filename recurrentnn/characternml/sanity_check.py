...
def question_1c_sanity_check():
    ...
    """
    print ("-"*80)
    print("Running Sanity Check for Question 1c: to_input_tensor_char")
    print ("-"*80)
    vocab = VocabEntry()
    ...
    print("Sanity Check Passed for Question 1c: to_input_tensor_char!")
    print("-"*80)
...
def question_1d_sanity_check():
    ...
    max_word_length = 21
    tensor_shape = [max_sentence_length, BATCH_SIZE, max_word_length, EMBED_SIZE] 
...
def question_1e_sanity_check():
    ...
    word_embed = EMBED_SIZE*2

    tensor_shape = [BATCH_SIZE, char_embed, max_word_length]
